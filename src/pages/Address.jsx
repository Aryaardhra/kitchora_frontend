...
const Address = () => {
  ...
  return (
    <div className="mt-16 pb-16">
        ...
        <div className="flex flex-col-reverse md:flex-row justify-around mt-10">
            <div className="flex-1 max-w-md">
                <form onSubmit={onSubmitHandler} className="space-y-3 mt-6 text-sm">
                 ...
                 <InputField handleChange={handleChange} address={address} name="email" type="text" placeholder="Email Address"/>
                  ...
                  <button className="w-full mt-6 bg-primary text-white py-3 hover:bg-secondary transition cursor-pointer uppercase">Save Address</button>
                </form>
            </div>
            <img src={location} alt="address" className="md:mr-8 mb-16 md:pl-20 " />
        </div>
    </div>
  )
}
